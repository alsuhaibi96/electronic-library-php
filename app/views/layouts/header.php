        ...
        <nav id="menu_nav" class=" ">
            <ol class="nav-ol">
                <li class="nav-li">
                    ...
                    <a href="#" onclick="showloginModal()">ادخل لحسابك أو سجل الآن </a>
                </li>
                <li class="nav-li">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="15">
                        <path fill="none" d="M0 0h24v24H0z" />
                ...
                <li class="nav-li">
                    <img class="sauid-icon" src="app/assets/images/saudi-arabia.svg" height="15" width="24">

                    <a href="#"> اليمن YER </a>
                </li>
                <li class="nav-li">

                    <a href="#" class="js-language"> English <img class="translate-icon" src="app/assets/images/translation.png" height="15"
                            width="24">
                    </a>
              ...
              <section>
                ...
                <i class="fa fa-bars " id="mobile_nav" onclick="toggleMenu()"></i>
                    <div class="logo">
                        <a href="../index.php"><img src="../assets/images/home - Copy.png" alt="BookStore"></a>
                    </div>
                    ...
                    <div class="cart">
                        <a href="cart.php"><img src="../assets/images/icon/cart-1.svg" class="cart__icon" alt="السلّة"></a>
